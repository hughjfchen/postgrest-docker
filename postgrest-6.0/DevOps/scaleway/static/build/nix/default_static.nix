...
let
  ...
  haskellPackages = pkgs.haskell.packages.ghc865.override {
    overrides = self: super: with pkgs.haskell.lib; {
      ...
      jose = dontCheck (doJailbreak (self.callCabal2nix "jose"
        (pkgs.fetchFromGitHub {
          owner = "frasertweedale" ;
          repo = "hs-jose" ;
          rev = "787b2e75a68ab1d81f4836fbd1a0ea20b372e895" ;
          sha256 = "00wj13yi3migid1x5d2jxysw9zbn9qp6ba1hx4f4sd0dibqgw2fz" ;
        }) {})) ;
      
      #jose = dontCheck (doJailbreak (self.callCabal2nix "jose"
      #  (pkgs.fetchurl {
      #    url = "mirror://hackage/jose-0.8.1.0.tar.gz" ;
